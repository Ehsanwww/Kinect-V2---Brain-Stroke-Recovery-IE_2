...
//    }
	...
	public class SensorData
	{
		...
		public Vector3[] depth2SpaceCoords; //Todo: ehsan depth2Space coordinate
	...
	{//Todo: ehsan maybe works with this parameter for jittering!! 
...
//		//public float rightThumbAngle;
	...
	/// </summary>
    public struct BodyFrameData //Todo: ehsan bodyFrameData
    {
...
//						}
	...
	public static JointType GetNextJoint(JointType joint)
	{
		switch(joint)
		{
			...
			case JointType.ElbowLeft: //Todo: ehsan after Elbow is hand in GameObject, but here is Wrist
				return JointType.WristLeft;
	...
	public static bool GetMultiSourceFrame(SensorData sensorData) //Todo ehsan: what is multiSource Frame
	{
		bool bResult = false;
