...
{	
	...
	protected bool isRigidBody = false; //Todo: ehsan parent doesnt obey physics.
	
	// private instance of the KinectManager
	protected KinectManager kinectManager;

	//Todo: ehsan hand events, grip, reelase, none
...
//            jointPosition.y - offsetPos.y + kinectManager.sensorHeight,  //!! this should be better investigated .. 
	...
	//Todo ehsan: Update Avatar method
...
//		}
	...
	//Todo: ehsan Rotation call start from here
	...
	protected void TransformSpecialBone(Int64 userId, KinectInterop.JointType joint, KinectInterop.JointType jointParent, int boneIndex, Vector3 baseDir, bool flip)
	{
		...
		//Todo ehsan: jointRotation and Direction
        if (!flip)
        {
...
//					}
	...
	//Todo: ehsan kinect joint rotaion to Avatar joint rotaiton
